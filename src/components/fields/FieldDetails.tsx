...
const FieldDetails: React.FC<FieldDetailsProps> = ({ field, onBookingClick }) => {
  return (
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="border-t pt-4 mt-4">
                <div className="text-2xl font-bold text-emerald-600">${field.price}</div>
          ...
          {field.description && (
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <p className="text-gray-600 whitespace-pre-line">{field.description}</p>
            </div>
          )}
        </div>
