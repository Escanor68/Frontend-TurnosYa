...
export const mockSportFields: SportField[] = [
  {
    ...
    description:
      'Complejo deportivo con 4 canchas de fútbol 5 con césped sintético de última generación.',
  },
  {
    id: '2',
    name: 'Complejo Messi',
    ...
    description:
      'Canchas de fútbol 7 con césped sintético profesional y sistema de drenaje.',
  },
  {
    id: '3',
    name: 'La Bombonerita',
  ...
  },
  {
    ...
    amenities: ['Vestuarios', 'Estacionamiento', 'Iluminación', 'Bar', 'WiFi'],
    description:
      'Complejo con 6 canchas de fútbol 5 con césped sintético de alta calidad.',
  },
  {
    id: '5',
    ...
    amenities: ['Vestuarios', 'Estacionamiento', 'Iluminación'],
    description:
      'Canchas de fútbol 7 con césped sintético y sistema de iluminación LED.',
  },
  {
    id: '6',
    ...
    description:
      'Canchas de fútbol 5 techadas, ideales para jugar con cualquier clima.',
  },
];
